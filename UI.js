            ...
            <div class="output-container">
                ...
                <div class="about-movie">
                    ...
                    <div class="details">
                        ...
                        <span data-movie="${movie.imdbID}" class="watchlist"><i class="fa-solid fa-circle-plus"></i> Watchlist</span>
                    </div>
            ...
            <div class="output-container">
                ...
                <div class="about-movie">
                    ...
                    <div class="details">
                        <span class="runtime">${movie.Runtime}</span>
                        <span class="genre">${movie.Genre}</span>
                        <span data-movie="${movie.imdbID}" class="remove"><i class="fa-solid fa-circle-minus"></i> Remove</span>
                    </div>
